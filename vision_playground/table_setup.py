...
# Updates "calibrations/croppings.json" with the outline of the table as well as each of the 4 regions of the table
# Call "table_setup.py [pitch number]" in order to do this one-time cropping
